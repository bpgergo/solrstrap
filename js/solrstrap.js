...
var SERVERROOT = 'http://176.63.139.241:8983/solr/gettingstarted/select/'; //SELECT endpoint
var HITTITLE = 'title';                                        //Name of the title field- the heading of each hit
var HITBODY = 'description';                                          //Name of the body field- the teaser text of each hit
var HITSPERPAGE = 40;                                          //page size- hits per page
var FACETS = [] //['topics','organisations'];                       //facet categories
var DATE = 'article_published_time';
var AUTHOR = 'author';

var FACETS_TITLES = {'topics': 'subjects'};  // selective rename facet names for display

var HITID = 'id'		// Name of the id field
var HITTEASER = 'description';	// Name of field to use for teaser
var HITLINK = 'og_url';		// Name of field to use for link
var ROOT_URL = 'https://web.archive.org/web/';

var ROOT_URL_NOL = 'https://web.archive.org/web/http://nol.hu/';
var FILE_ROOT = '/home/bpgergo/Work/Workspaces/py/wayback/websites/nol.hu/';
            ...
            success: function (result) {
                ...
                if (result.response.docs.length > 0) {
                    ...
                    for (var i = 0; i < result.response.docs.length; i++) {
                        ...
                        var teaser = undefined;//normalize_ws(get_maybe_highlit(result, i, HITTEASER));
                        //var link = ROOT_URL + result.response.docs[i][HITLINK];
                        var link = result.response.docs[i][HITID];
                    ...
                    //available facets
                    //console.log("result.facet_counts:")
                    //console.log(result.facet_counts);
